...
if __name__ == "__main__":
    ...
    filename = f"{args.model_name}-world_size{args.world_size}-tp{args.tensor_model_parallel_size}-pp{args.pipeline_model_parallel}-ep{args.expert_model_parallel_size}-bs{args.micro_batch}-seq{args.seq_length}-MoE-{f'{args.num_experts}-topk{args.moe_router_topk}' if args.moe_enable else False}-{phase}"
    ...
    if args.aiob_enable:
        ...
        aiob_output_filename = f"{args.model_name}-world_size{args.world_size}-tp{args.tensor_model_parallel_size}-pp{args.pipeline_model_parallel}-ep{args.expert_model_parallel_size}-bpg{args.micro_batch}-seq{args.seq_length}-MoE-{f'{args.num_experts}-topk{args.moe_router_topk}' if args.moe_enable else False}-{phase}.txt"
